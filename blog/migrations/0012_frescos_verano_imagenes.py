...
# Imagen de portada + una imagen específica para cada destino.
# Las imágenes se sirven mediante URL externa, que ya es compatible con PostImage.
IMAGE_URLS = [
    ...
    "https://www.gettyimages.com/detail/photo/landscape-in-the-sierra-de-gredos-royalty-free-image/",
    "https://estaticos-cdn.prensaiberica.es/clip/0aa8a87a-fe2b-4241-a19f-6afbf9ef7bdb_alta-libre-aspect-ratio_default_0.jpg",
    "https://cdn2.paraty.es/test4-copia2/images/326f9c7774f1ad3%3Ds800",
]
...
INLINE_IMAGES = {
    ...
    "<h2>8. Sierra de Gredos</h2>": '<h2>8. Sierra de Gredos</h2><img src="https://www.gettyimages.com/detail/photo/landscape-in-the-sierra-de-gredos-royalty-free-image/" alt="Paisaje de montaña en la Sierra de Gredos" loading="lazy" style="width:100%;height:auto;border-radius:16px;margin:20px 0;">',
